...
public class ConnectionHandler extends Thread
{
    ...
    public static String seconOPT = "Wait";
    ...
    public void register(String [] field)
    {
        ...
        else
        {
            ...
            synchronized(seconOPT)
            {
                seconOPT = "registerUser";
                seconOPT.notifyAll();
            }
        }
    }
    ...
    public void makeChallenge(String[] field)
    {
        ...
        else
        {
            if(field.length > 1)
            {
                ...
                Challenge temp = new Challenge(field[0], aux, 1);
                data.addChallenge(temp);
                
                loggedUser = data.getUserByName(field[0]);
    ...
    public void waitFor(Challenge ch)
    {
    ...
    public void runChallenge(Challenge ch)
    {
        ...
        for(Question q : pq.getQuiz())
        {
            ...
            if(q.getNumAns() == Integer.parseInt(field[0]))
            {
                ...
                System.out.println("loggeduser " + loggedUser.getName());
                System.out.println("loggeduserpoints " + loggedUser.getPoints());
